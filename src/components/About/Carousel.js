...
export default function Carousel({
  ...
  return (
    <div className="carousel" onClick={() => setHideElements(!hideElements)}>
      <div className="carousel-button-close" onClick={onCloseButtonClick} style={setDisplayNone()}>
        <ButtonClose />
      </div>
      <div
        className="carousel-left-bar-wrapper"
        ...
        >
          ...
          {selectedImage.photographer && (
            <span className="photography">
              (Photography {selectedImage.photographer})
            </span> 
          )}
        </p>
      ...
      <div
        className="carousel-right-bar-wrapper"
